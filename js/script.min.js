    ...
    $(document).ready(function() {
     ...
     document.getElementById("instructions2").innerHTML = "Type a question & click Search.";
...
window.location.href = "https://google.gprivate.com/search.php?search?q="+ Keywords;
